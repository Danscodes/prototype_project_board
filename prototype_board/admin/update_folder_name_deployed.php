...
$user_id = $_SESSION['user_id'];
	...
	$rename_new_folder_path = "http://projects.skiedflakes.site/prototype_board/uploads/".$folder_newname;
	$old_foleder_path = "http://projects.skiedflakes.site/prototype_board/uploads/".$folder_old_name;
